//
//  LeWeatherSubBView.swift
//  SwiftWeather
//
//  Created by 飞 刘 on 16/3/22.
//  Copyright © 2016年 Jake Lin. All rights reserved.
//

import UIKit

class LeWeatherSubBView: UIView {
    var view: UIView!
    ...
    @IBOutlet weak var windLebel: UILabel!
    ...
    @IBInspectable var wind: String? {
        get {
            return windLebel.text
        }
        
        set {
            windLebel.text = newValue
        }
    }
